...
print("""presione el numero segun la opcion requerida:
      ...
      11- Seleccione un nombre a eliminar
      12- Contar cuantos nombres tienen mas de 5 caracteres. 
      12- Finalizar""")
option = 0
flag = True
while flag:
    ...
    match option:
     ...
     case 9:
         ...
         for i in lista_nombres:
             if len(i)> 5:
                 print(i)
                 contador += 1
         print(f' en total son {contador} los nombres que tienen mas de 5 letras')
     case 10:
         min_may= 0
     ...
     case 11:
         nombre= input("elija un nombre para eliminar de la lista: ")
         if nombre in lista_nombres:
            lista_nombres.remove(nombre)
            print(f'El nombre {nombre} se ha eliminado de la lista.')
         else:
             print('ese nombre no esta en la lista')
     case 12:
         contador= 0
